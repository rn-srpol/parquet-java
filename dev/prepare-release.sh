...
./mvnw release:clean
./mvnw release:prepare -DskipTests -Darguments="-DskipTests" -DpreparationGoals="clean" -Dtag="$tag" "-DreleaseVersion=$release_version" -DdevelopmentVersion="$new_development_version"
